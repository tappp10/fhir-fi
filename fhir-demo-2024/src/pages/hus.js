  ...
  return (
    <Demo roles={roles} location={location}>
      ...
      <section id="fhir">
        ...
        <p>
          For this reason, HUS has made the "FHIR FIRST" policy, on the basis of which HUS
          primarily uses and requires from its partners standard interfaces in accordance with the
          FHIR standard in implementing the interoperability (integrations) of information systems.
        </p>
        <p>
